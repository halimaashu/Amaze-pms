...
export default function Hero() {
  return (
    <section className="relative flex items-center justify-center py-20 md:py-28 overflow-hidden bg-[#040711] bg-grid-pattern">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left space-y-8">
            {/* Tagline Badge */}
            <div className="inline-flex items-center space-x-2 px-3 py-1.5 rounded-full border border-sky-500/20 bg-sky-500/10 text-sky-400 text-xs font-semibold tracking-wider uppercase animate-float">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <a
                href="#services"
                className="w-full sm:w-auto relative inline-flex items-center justify-center px-8 py-4 rounded-xl font-bold text-base text-white overflow-hidden group transition-all duration-300 shadow-lg shadow-sky-500/20 hover:shadow-sky-500/35"
              >
              ...
              <a
                href="#estimator"
                className="w-full sm:w-auto px-8 py-4 rounded-xl border border-white/10 bg-white/5 text-white font-bold hover:bg-white/10 hover:border-white/20 transition-all duration-300 text-center"
              >
                Estimate Footprint
              </a>
            </div>
            ...
            {/* Quick Metrics */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-8 border-t border-white/5 max-w-3xl mx-auto lg:mx-0">
              <div>
              ...
              <div>
                <h3 className="text-3xl font-extrabold text-white">25 yrs</h3>
                <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider mt-1">
                  Est. Since 2001
                </p>
              </div>
          ...
          <div className="lg:col-span-5 relative flex justify-center items-center">
            ...
            <div className="relative w-full max-w-md rounded-2xl glass-panel p-6 border border-white/10 shadow-2xl animate-float">
              {/* Top window dots */}
              <div className="flex items-center space-x-1.5 pb-4 border-b border-white/5 mb-6">
                <span className="w-3 h-3 rounded-full bg-rose-500/80"></span>
                <span className="w-3 h-3 rounded-full bg-amber-500/80"></span>
                <span className="w-3 h-3 rounded-full bg-emerald-500/80"></span>
                <span className="text-[10px] text-slate-400 ml-4 font-mono">amaze-operations-map.sh</span>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center bg-white/5 p-3.5 rounded-xl border border-white/5">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-400">All properties status updated</p>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center text-xs p-3 border border-white/5 rounded-xl bg-slate-900/40">
                    <span className="text-slate-400 font-mono">HYD-TECH-04</span>
                  ...
                  <div className="flex justify-between items-center text-xs p-3 border border-white/5 rounded-xl bg-slate-900/40">
                    <span className="text-slate-400 font-mono">BLR-SEC-12</span>
                  ...
                  <div className="flex justify-between items-center text-xs p-3 border border-white/5 rounded-xl bg-slate-900/40">
                    <span className="text-slate-400 font-mono">BBS-SOFT-09</span>
                ...
                <div className="grid grid-cols-2 gap-3 pt-2">
                  <div className="bg-slate-950/60 p-3 rounded-xl border border-white/5">
                    ...
                    <p className="text-lg font-bold text-white mt-1">15,000+</p>
                  </div>
                  <div className="bg-slate-950/60 p-3 rounded-xl border border-white/5">
                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">
                      Active Sites
                    </p>
                    <p className="text-lg font-bold text-white mt-1">320+</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -top-6 -right-6 glass-panel px-4 py-3 rounded-xl border border-white/10 shadow-lg flex items-center space-x-2 animate-float" style={{ animationDelay: "2s" }}>
            ...
            <div className="absolute -bottom-6 -left-6 glass-panel px-4 py-3 rounded-xl border border-white/10 shadow-lg flex items-center space-x-2 animate-float" style={{ animationDelay: "4s" }}>
              <Activity className="w-5 h-5 text-emerald-400" />
              <div>
                <p className="text-[9px] text-slate-400 font-bold uppercase tracking-wider">Response time</p>
                <p className="text-xs font-bold text-white">&lt; 15 mins SLA</p>
              </div>
            </div>
          </div>
        </div>
